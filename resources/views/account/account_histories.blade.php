...
<div class="row">
    ...
    <div class="step-indicator" style="float: right">
        <a class="btn btn-primary btn-sm" href="{{ url('/accounts/account-list') }}"> <i class="ti-arrow-left"></i>  Go Back</a> 
        </div>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="panel panel-custom panel-border">
            <div class="panel-heading">
                <h4 class="panel-title1"> Account Credit History  </h4>
        ...
        <table id="account-table" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    <button class="btn btn-success btn-sm  waves-effect waves-light edit_account" data-id="{{ $account->id }}" data-toggle="modal" data-target=".bs-example-modal-sm"><i class="fa fa-edit"></i></button>
                    @if (Auth::user()->role_id == 1 OR Auth::user()->role_id == 2)
                    <a class="btn btn-sm btn-danger" href="{{ url('accounts/account-histories/delete/'.$account->id) }}" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i></a>
                    @else 
                    @endif    
                </td>
                </tr>
