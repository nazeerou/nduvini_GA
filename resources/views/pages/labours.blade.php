        ...
        <div class="panel panel-custom panel-border">
            <div class="panel-heading">
                ...
                <button type="submit" class="btn btn-info btn-rounded w-lg waves-effect waves-light m-b-20 m-t-10" id="" data-toggle="modal" data-target=".bs-example-modal-lg"> + New Labour </button>
                 ...
                 <h3 class="panel-title1"> All Labour  </h3>
                <br/>
            </div>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        @foreach($products as $key => $product)
                            <tr>
                                ...
                                <td> {{ strtoupper($product->labour) }} </td>
                                <td> {{ $product->rate }} </td>
                                <td>{{ number_format($product->charge) }}</td>
                                <td>
								...
								<a class="btn btn-sm btn-danger show-details" href="{{ url('labours/details/delete/'.$product->id) }}" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"></i></a>   
                            </td>       
                            </tr>
                          @endforeach  
                            </tbody>
...
<!--  Modal content for the above example -->
<div class="modal fade bs-example-modal-1" tabindex="-1" role="dialog" id="labour_modal" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-lg">
