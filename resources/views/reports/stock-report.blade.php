    ...
    <div class="col-lg-12">
        <div class="panel panel-custom panel-border">
            <div class="panel-heading">
                <h3 class="panel-title"> Filter By Item  </h3>
            </div>
              ...
              <div class="filter">                  
                ...
                <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <select name="product_id" class="form-control select2" id="product_id" required>
                                  <option> Select Item </option>
                                   @foreach($items as $p)
                                   <option value="{{ $p->id }}"> {{ strtoupper($p->item_name) }}  - {{ strtoupper($p->model) }} </option>
                                   @endforeach
                             </select>        
                            </div>
                        </div>
                     ...
                     <div class="col-md-2 m-t-10">
                        <div class="form-group">
                                <button type="button" id="search" style="background: #E74C3C; color: white;" class="btn  btn-rounded pull-right m-b-0 m-t-10" id="search"><span class="pull-left" style="padding: 5px;"> FILTER </span>
  ...
  $(document).ready(function () {
    ...
    $('#product_id').on('change', function() {
         ...
         $.ajax({
             ...
             data: { product_id: product_id, year: year },
             type: "GET",
             success: function (response) {
                $('#container-box').show();
                $("tbody").html(response);
