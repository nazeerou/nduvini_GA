...
class ProformaInvoiceMail extends Mailable
{
     ...
     * @return void
     */
    public function __construct($clients, $sales, $total_discounts, $vat_charges, $tax, $grand_total_amount, $labours, $total_labours, $total_sales, $id, $products, $client_name, $vat_calculations, $vehicle, $settings)
    {
    ...
    {
        // Generate the PDF
        $pdf = \PDF::loadView('estimations.estimation-details-pdf', [
            'sales' => $this->sales,
        ...
        return $this->from('nduvinitabora@hotmail.com', 'Nduvini Autoworks  Limited')
                    ...
                    ->view('proforma-mail') // your email view
                    ->attachData($pdfContent, 'Proforma-Invoice.pdf', [
