...
class AccountsController extends Controller
{
  ...
  public function deleteAccount($id) {
        ...
        $expenses = Account::where('id', $id)->first();

        $expenses->delete();

        return redirect()->back()->with('error', 'Account Deleted');
    }

  public function deleteAccountHistories($id) {

        $expenses = AccountHistory::where('id', $id)->first();

        $expenses->delete();

        return redirect()->back()->with('error', 'Account Histories Deleted');
    }
